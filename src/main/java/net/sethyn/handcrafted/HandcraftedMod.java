package net.sethyn.handcrafted;
...
@Mod("handcrafted")
public class HandcraftedMod {
	public static final Logger LOGGER = LogManager.getLogger(HandcraftedMod.class);
	public static final String MODID = "handcrafted";

	public HandcraftedMod(IEventBus modEventBus) {
