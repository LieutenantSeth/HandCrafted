package net.sethyn.handcrafted.entity;
...
public class CustomEyeOfEnderEntity extends EyeOfEnder {
	public static final ResourceLocation ENTITY_ID = ResourceLocation.fromNamespaceAndPath("handcrafted", "custom_eye_of_ender");
