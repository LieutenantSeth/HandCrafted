package net.sethyn.handcrafted.network;
...
public record PlayPlayerAnimationMessage(int player, String animation, boolean override, boolean firstPerson) implements CustomPacketPayload {
	...
	public static final Type<PlayPlayerAnimationMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(HandcraftedMod.MODID, "play_player_animation"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		HandcraftedMod.addNetworkMessage(PlayPlayerAnimationMessage.TYPE, PlayPlayerAnimationMessage.STREAM_CODEC, PlayPlayerAnimationMessage::handleData);
	}
}